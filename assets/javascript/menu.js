...
var WebPages = [
    ...
    /* page 1 */newPage('<nav> <div class="nav-wrapper" id="navBar"> <img src="assets&#92images&#92waterdrop.png" id="logo"> <img src="assets&#92images&#92hydro.png" id="logo2"> <a class="brand-logo center"> <i class="material-icons" style="color: #fe8a71;"></i> </a> </nav><div id="mainStarterBox"> <p>Welcome to Hyrdo Budget! Your best source for simply saving money based on your expenses and budget. Click the button below to begin! </p><button id="startButton" class="x next-page-button">Get Started!</button> </div>'),
    /* page 2 */newPage('<nav> <div class="nav-wrapper" id="navBar"> <img src="assets&#92images&#92waterdrop.png" id="logo"> <img src="assets&#92images&#92hydro.png" id="logo2"> <a class="brand-logo center"> <i class="material-icons" style="color: #fe8a71;"></i> </a> </nav><div class="container" id="mainStarterBox"> <p class="x">What is your average <a id="toolTipButton" class="tooltipped x" data-position="top" data-tooltip="Net income is the amount of money an individual makes after the usual deductions from a paycheck, such as social security, 401k, taxes, etc...">net</a> income per month?</p> <form> <input id="userInput" type="text" placeholder="Amount" value="" /> </form> <div id="startButton" class="x submit-income next-page-button">Submit</div> </div> </div>'),
    //etc...
...
function updateTotalExpensesDiv() {
    ...
    $('#totalExpensesDisplayed').text(total_expenses.format('$0,.00'));
}
...
$(document).ready(function () {
    ...
    $("body").on("click", '.submit-new-bill', function () {
        ...
        var new_bill = {
            ...
            date: moment($("#billDateInputTopPage").val().trim(), 'MMM DD, YYYY').format('Do')
        }
